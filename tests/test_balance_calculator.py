...
class TestBalanceCalculator(unittest.TestCase):
    ...
    def test_pending_transactions(self):
        ...
        df_txn = pd.DataFrame(
            columns=["accountId", "id", "date", "amount", "direction"]
        )
        ...
        df_res = calculate_balance_per_transaction(df_txn, df_acc, include_pending=True)
        ...
        self.assertAlmostEqual(
            df_res.iloc[0]["balance_after"], 1050.0
        )  # Initial was 1050
