...
import pandas as pd
import numpy as np
from hierarchical.data.preprocess_tensors import process_single_account, patch_df
...
class TestPreprocess(unittest.TestCase):
    def setUp(self):
        ...
        # Mock Config
        self.config = {"max_days": 5, "max_txns": 3}
    ...
    def test_process_single_account(self):
        ...
        data = [
            {
                ...
                "date": "2023-01-01",
                "amount": 100,
                "personeticsCategoryGroupId": "G1",
                "personeticsSubCategoryId": "S1",
                "counterParty": "C1",
            },
            {
                "accountId": "A1",
        ...
        # Run Directly
        res = process_single_account(
            "A1", df, self.vocabs, self.balance_cache, self.config
        )
