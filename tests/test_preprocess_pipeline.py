...
class TestPreprocessPipeline(unittest.TestCase):
    ...
    def test_train_mode_pipeline(self):
        ...
        test_args = [
            ...
            '--mode', 'train',
            '--data_file', self.txn_file,
            '--account_file', self.acc_file,
            '--output_dir', self.output_dir,
            '--vocab_dir', self.vocab_dir,
            '--min_days', '1' # Ensure our 2 days pass
        ]
    ...
    def test_vocab_reuse(self):
        ...
        test_args = [
            ...
            '--account_file', self.acc_file,
            '--output_dir', self.output_dir,
            '--vocab_dir', self.vocab_dir, # Should load from here
            '--min_days', '1'
        ]
        ...
        self.assertTrue(os.path.exists(os.path.join(self.vocab_dir, 'cat_group_vocab.pkl')))
